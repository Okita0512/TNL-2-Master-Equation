...
data2 = np.loadtxt("./Redfield/Model4.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'red', label = "Redfield")

data2 = np.loadtxt("./TNL-2/Model4.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'blue', label = "TNL-2")

data2 = np.loadtxt("./benchmark/Model4.dat", dtype = float)
...
ax.set_title('Spin Boson Model 4', font = 'Times New Roman', size = 20)
...
plt.savefig("Spin Boson Ohmic Model 4.pdf", bbox_inches='tight')