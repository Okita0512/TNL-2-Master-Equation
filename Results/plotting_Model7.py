...
data2 = np.loadtxt("./Redfield/Model7.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'red', label = "Redfield")

data2 = np.loadtxt("./TNL-2/Model7.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'blue', label = "TNL-2")

data2 = np.loadtxt("./benchmark/Model7.dat", dtype = float)
...
ax.set_title('Spin Boson Model 7', font = 'Times New Roman', size = 20)
...
plt.savefig("Spin Boson Ohmic Model 7.pdf", bbox_inches='tight')