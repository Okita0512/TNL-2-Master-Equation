...
data2 = np.loadtxt("./Redfield/Model5.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'red', label = "Redfield")

data2 = np.loadtxt("./TNL-2/Model5.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'blue', label = "TNL-2")

data2 = np.loadtxt("./benchmark/Model5.dat", dtype = float)
...
ax.set_title('Spin Boson Model 5', font = 'Times New Roman', size = 20)
...
plt.savefig("Spin Boson Ohmic Model 5.pdf", bbox_inches='tight')