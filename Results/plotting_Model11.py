...
data2 = np.loadtxt("./Redfield/Model11.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'red', label = "Redfield")

data2 = np.loadtxt("./TNL-2/Model11.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'blue', label = "TNL-2")

data2 = np.loadtxt("./benchmark/Model11.dat", dtype = float)
plt.plot(data2[:, 0], data2[:, 1], "o", linewidth = 2.0, color = 'navy', label = "QuAPI")
...
ax.set_title('Spin Boson Model 11', font = 'Times New Roman', size = 20)
...
plt.savefig("Spin Boson Ohmic Model 11.pdf", bbox_inches='tight')