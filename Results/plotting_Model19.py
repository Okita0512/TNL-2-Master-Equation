...
data2 = np.loadtxt("./Redfield/Model19.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'red', label = "Redfield")

data2 = np.loadtxt("./TNL-2/Model19.txt", dtype = float)
...
data2 = np.loadtxt("./benchmark/Model19.dat", dtype = float)
...
plt.savefig("Spin Boson Debye Model 19.pdf", bbox_inches='tight')