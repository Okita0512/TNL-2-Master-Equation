...
data2 = np.loadtxt("./Redfield/Model3.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'red', label = "Redfield")

data2 = np.loadtxt("./TNL-2/Model3.txt", dtype = float)
plt.plot(data2[:, 0], data2[:, 1] - data2[:, 7], "-", linewidth = 2.0, color = 'blue', label = "TNL-2")

data2 = np.loadtxt("./benchmark/Model3.dat", dtype = float)
...
ax.set_title('Spin Boson Model 3', font = 'Times New Roman', size = 20)
...
plt.savefig("Spin Boson Ohmic Model 3.pdf", bbox_inches='tight')